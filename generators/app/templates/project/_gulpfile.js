...
gulp.task('compile', ['compile-sass', 'compile-typescript', 'compile-assets', 'compile-html'], function(){
...
gulp.task('compile-typescript', [], function(){
  gulp.src('src/**/*.ts').pipe(sourcemaps.init()).pipe(typescript(tsconfig)).js.pipe(embedTemplates()).pipe(sourcemaps.write('.', {sourceRoot: '/src'})).pipe(gulp.dest('dist'));
});
